        ...
        <div class="h-screen hidden lg:block my-4 ml-4 shadow-lg relative w-80">
          <div class="bg-white h-full rounded-2xl dark:bg-gray-700">
            <div class="flex items-center justify-center pt-6">
              ...
              <p class="font-bold text-xl text-black dark:text-white px-3">
                HealthOnline
              </p>
            </div>
            <nav class="mt-6">
              <div>
                <SideNavItem title={"Dashboard"} active={true} />

                <a
                  class="w-full font-thin uppercase text-gray-500 dark:text-gray-200 flex items-center p-4 my-2 transition-colors duration-200 justify-start dark:hover:text-blue-500 hover:text-blue-500"
                  href="#"
                >
                ...
                <div class="relative p-1 flex items-center justify-end w-1/4 ml-5 mr-4 sm:mr-0 sm:right-auto">
                  <a href="#" class="block relative">
                    <img
                      alt="profile"
                      src={avatar}
                      class="mx-auto object-cover rounded-full h-10 w-10 shadow-xl"
                    />
                  </a>
                </div>
              </div>
